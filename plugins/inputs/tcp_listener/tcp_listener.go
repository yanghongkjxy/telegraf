...
func (t *TcpListener) Start(acc telegraf.Accumulator) error {
	...
	t.MaxConnections = selfstat.Register("self_tcp_listener", "max_connections", tags)
	t.MaxConnections.Set(int64(t.MaxTCPConnections))
	t.CurrentConnections = selfstat.Register("self_tcp_listener", "current_connections", tags)
	t.TotalConnections = selfstat.Register("self_tcp_listener", "total_connections", tags)
	t.PacketsRecv = selfstat.Register("self_tcp_listener", "packets_received", tags)
	t.BytesRecv = selfstat.Register("self_tcp_listener", "bytes_received", tags)
