...
func (h *HTTPListener) Start(acc telegraf.Accumulator) error {
	...
	h.BytesRecv = selfstat.Register("self_http_listener", "bytes_received", tags)
	h.RequestsServed = selfstat.Register("self_http_listener", "requests_served", tags)
	h.WritesServed = selfstat.Register("self_http_listener", "writes_served", tags)
	h.QueriesServed = selfstat.Register("self_http_listener", "queries_served", tags)
	h.PingsServed = selfstat.Register("self_http_listener", "pings_served", tags)
	h.RequestsRecv = selfstat.Register("self_http_listener", "requests_received", tags)
	h.WritesRecv = selfstat.Register("self_http_listener", "writes_received", tags)
	h.QueriesRecv = selfstat.Register("self_http_listener", "queries_received", tags)
	h.PingsRecv = selfstat.Register("self_http_listener", "pings_received", tags)
	h.NotFoundsServed = selfstat.Register("self_http_listener", "not_founds_served", tags)
